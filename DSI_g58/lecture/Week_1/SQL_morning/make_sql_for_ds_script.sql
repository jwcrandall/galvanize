...
FROM '/Users/rdelapp/Galvanize/DSI/lecture/SQL_morning/student_data.csv'
DELIMITER ',' CSV HEADER;

COPY term_gpa(id,term,gpa)
FROM '/Users/rdelapp/Galvanize/DSI/lecture/SQL_morning/term_gpa_data.csv'
DELIMITER ',' CSV HEADER;

COPY degrees(id,term,degree)
FROM '/Users/rdelapp/Galvanize/DSI/lecture/SQL_morning/degrees_data.csv'
DELIMITER ',' CSV HEADER;
