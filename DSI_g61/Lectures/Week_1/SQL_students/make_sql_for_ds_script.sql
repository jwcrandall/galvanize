...
FROM '/Users/rdelapp/Galvanize/DSI_g61/Lectures/Week_1/SQL_students/student_data.csv'
DELIMITER ',' CSV HEADER;

COPY term_gpa(id,term,gpa)
FROM '/Users/rdelapp/Galvanize/DSI_g61/Lectures/Week_1/SQL_students/term_gpa_data.csv'
DELIMITER ',' CSV HEADER;

COPY degrees(id,term,degree)
FROM '/Users/rdelapp/Galvanize/DSI_g61/Lectures/Week_1/SQL_students/degrees_data.csv'
DELIMITER ',' CSV HEADER;
